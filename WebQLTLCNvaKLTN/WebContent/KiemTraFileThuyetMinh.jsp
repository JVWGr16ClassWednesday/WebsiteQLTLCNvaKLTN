...
<body>
    <div class="container">
        ...
        <div class="row">
        <form action="KiemTraFileThuyetMinhServlet" method="post" enctype="multipart/form-data" accept-charset="utf-8">
        	<div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="txt_percent" name="txt_percent"> %
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Phần trăm giống</th>
                                    <th class="text-center">Chi tiết</th>
                                </tr>
                            </thead>
                            <tbody>
                                 <c:forEach items="${value_percen}" var="tmp" varStatus="status">
                                 
	        							 <tr>
				                               <td><center>${tmp.getTendt()}</center></td>
				                               <td><center>${tmp.getLoaidt()}</center></td>
				                               <td><center>${tmp.getGvhd()}</center></td>
				                               <td><center>${value_kq[status.index]} %</center></td>
				                               <td>
