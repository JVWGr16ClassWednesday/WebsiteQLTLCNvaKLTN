...
<body>
    <div class="container">
        ...
        <div class="row">
        <form action="SoSanhDeTaiServlet" method="post">
        	<div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <label>Nhập thông tin: </label>
	                    <textarea class="form-control input-lg" rows="5" id="nhap_abstract" name="nhap_abstract" placeholder="Nhập vào nội dung tóm tắt của đề tài"></textarea>
                    <br />
                    <div class="input-group">
