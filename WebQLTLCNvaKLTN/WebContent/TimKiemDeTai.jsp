        	...
        	<form action="TimKiemDeTaiServlet" method="post">
                ...
                <div class="panel-body">
                    <div class="input-group">
                        <input type="text" class="form-control" name="txttimkiem" id="txttimkiem" placeholder="Nhập nội dung tìm kiếm hoặc từ khóa về tên đề tài, mô tả đề tài, tên sinh viên thực hiên, giáo viên dướng dẫn hoặc tên tài liệu">
